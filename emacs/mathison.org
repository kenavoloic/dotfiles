...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'default nil :family monoParDefaut)
  (set-face-attribute 'fixed-pitch nil :family monoParDefaut)
  (set-face-attribute 'variable-pitch nil :family variableParDefaut)
