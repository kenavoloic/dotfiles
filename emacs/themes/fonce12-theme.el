...
;;      (cyberpunk-black   noir-1)	  
   ...
   'fonce12
	...
	`(org-level-1 ((,class (:foreground ,bleu-7 :weight bold))))
	`(org-level-2 ((,class (:foreground ,jaune-1 :weight bold))))
	...
	`(org-ellipsis ((,class (:foreground ,rouge-1))))
	...
	`(org-block-begin-line  ((,class (:foreground ,violet-3))))
	`(org-block-background ((,class (:background ,gris-7))))
	`(org-block-end-line  ((,class (:foreground ,violet-3))))
